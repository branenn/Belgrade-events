...
class AdminHomeKontroler extends Controller
{
    ...
    protected function upisKorisnika(array $data)
    {
        ...
        return User::create([
            ...
            'updated_at'=>Carbon::now()->addSecond(1),
    ...
    public function listaKorisnika()
    {
        ...
        $stranice=$this->promenastrane($korisnici,5);
        return view('admin.listakorisnika')
            //->with('korisnici', $korisnici)
    ...
    public function getDogadjaji()
    {
        ...
        $stranice=$this->promenastrane($dogiocena,5);

        return view('admin.dogadjaji')
            //->with('dog',$dogiocena)
            ->with('stranice', $stranice)
            ->with('sortiranje',$sortiranje);
