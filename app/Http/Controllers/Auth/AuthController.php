...
// prilikom reg da dobije poruku mora admin da razmotri zahtev za reg
    public function register(Request $request)
    {
        ...
        if (Auth::user()->status == 0) {
            return redirect('/')->with('message', 'Uspešno ste poslali zahtev za registraciju!')->with(Auth::logout());
        }
    }
